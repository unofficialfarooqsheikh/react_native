  ...
  return (
    <View style={styles.CardSlidersSlider}>
      <View style={styles.TextView}>
        <Image source={{ uri: data.ImageUrl }} style={styles.imageCover} />
      </View>
          ...
          <View style={{ flex: 1, flexDirection: "row" }}>
            <View style={{ flex: 1 }}>
              <Text style={styles.paragraph}>
                Raised : <Text style={styles.Currency}>{data.Raised}</Text>
              </Text>
            </View>
            <View style={{ flex: 1 }}>
              <Text style={{ textAlign: "right" }} style={styles.GoalsText}>
                {" "}
                Goals :<Text style={styles.Currency}>{data.Goals}</Text>
              </Text>
            </View>
          </View>
          <View style={{ marginTop: 20 }}>
            <Text style={styles.ContentDiv}>{data.Content1}</Text>
          </View>
